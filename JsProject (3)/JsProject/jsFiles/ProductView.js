...
//   // update badge in this window
//   const badge = document.getElementById("cartCount");
//   if (badge) badge.textContent = cart.length;

//   // dispatch a custom event for other components on the same page
//   window.dispatchEvent(new CustomEvent("cart-updated", { detail: { length: cart.length, items: cart } }));
